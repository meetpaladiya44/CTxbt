...
export default function UserMetricsDashboard() {
  ...
  // Tooltip content for AI analysis
//   const getTooltipContent = (metric: string) => {
//     switch (metric) {
//       case "herdedVsHidden":
//         return "AI analysis of whether the user's content follows crowd behavior (Herded) or creates unique perspectives (Hidden)";
//       case "convictionVsHype":
//         return "AI analysis of whether the user posts based on strong beliefs (Conviction) or trending topics (Hype)";
//       case "memeVsInstitutional":
//         return "AI analysis of whether the user's content is meme-based or institutional/professional";
//       default:
//         return "Analysis by AI";
//     }
//   };

  if (loading) {
    return (
      <div className="w-full min-h-screen bg-gradient-to-br from-gray-900 to-black flex flex-col items-center justify-center">
        <div className="w-24 h-24 relative">
          <div className="absolute inset-0 rounded-full border-t-4 border-blue-500 animate-spin"></div>
          <div className="absolute inset-2 rounded-full border-t-4 border-cyan-500 animate-spin animation-delay-150"></div>
          <div className="absolute inset-4 rounded-full border-t-4 border-blue-500 animate-spin animation-delay-300"></div>
        </div>
